...
def get_match_ids():
    url = 'https://www.betole.com/restapi/offer/sr/sport/S/mob?annex=0&desktopVersion=2.33.6.14&locale=sr'
    headers = {
...
async def fetch_and_process(session, match_id, keys):
    ...
    try:
        ...
        print(f'Betole timeout: {match_id}')
...
async def betole():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        if results:
            ...
            df.to_csv('/content/betole.csv', index=False, header=head)
